...
$raw_path = $raw_path ?: '/';
if ($raw_path === '/index.php') $raw_path = '/';
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Google+Sans+Flex:ROND,wght@0..100,300..800&display=swap" rel="stylesheet"/>
...
<nav class="nav">
    <div class="wrap nav-row">
        <a href="<?php echo BASE_URL; ?>/" class="nav-logo">LUNO<span class="dot">.</span></a>
        <ul class="nav-links">
