...
export default function InAppPrivacy() {
  return (
    <LegalLayout
      title="Privacy Policy"
      subtitle="How Fintraq handles your data — spoiler: it doesn't."
      version="Effective: April 2, 2026 &middot; Version 1.0.1"
      summary={
        <>
          <strong>The short version:</strong> Fintraq is built local-first. All
