  ...
  return (
    <>
      <LegalSection title="1. Information We Collect">
        <p>Numeo does not collect any personal information. The app operates entirely offline and on-device. Specifically:</p>
        <ul>
        ...
        <p>The only data that exists in relation to Numeo is data you create yourself, stored locally on your device.</p>
      </LegalSection>

      <LegalSection title="2. How Your Data Is Stored">
        <p>All data you enter into Numeo — including transactions, account details, categories, and preferences — is stored in a SQLite database on your device. This data:</p>
        <ul>
          <li>Never leaves your device.</li>
          <li>Is not backed up to any Numeo-operated cloud service.</li>
      ...
      <LegalSection title="3. Third-Party Services">
        <p>Numeo does not integrate with any third-party analytics, advertising, or data services for tracking. However, we do use:</p>
        <ul>
          <li><strong>Google Play Billing:</strong> For processing in-app purchases (Premium features). Google Play Billing handles payment information but does NOT have access to your financial data stored in Numeo.</li>
        ...
        <p>The following are NOT included in Numeo:</p>
        <ul>
      ...
      <LegalSection title="4. In-App Purchases and Premium Features">
        <p>Numeo offers both free and Numeo Pro features. Numeo Pro includes Dashboard insights (spending alerts, saving trends, weekly summaries), extended analytics (30-day, 90-day, 12-month ranges, period charts, category breakdowns, behavioral metrics), global search, and CSV export.</p>
        ...
        <ul>
          ...
          <li>Payment information (credit card, billing address) is handled by Google and is NOT stored in Numeo</li>
        ...
        <ul>
          ...
          <li>Numeo receives no information about your payment method or billing details</li>
          <li>Your purchase status is tied to your Google Play account, not to Numeo's servers</li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="6. Data Security">
        <p>Numeo implements security measures to protect your data:</p>
        <ul>
          ...
          <li>Your device's built-in security features (lock screen, biometric authentication) protect access to Numeo</li>
        </ul>
      ...
      <LegalSection title="7. Data Retention and Backups">
        <p><strong>Data Retention:</strong> Numeo retains your data for as long as you keep the app installed on your device. You can delete all data at any time using the factory reset feature.</p>
        <p><strong>Device Backups:</strong> If you use Android's automatic backup feature (Google Drive, other cloud services), your Numeo data may be included based on your device settings. This is subject to those services' privacy policies, not ours.</p>
        <p><strong>Numeo-Operated Backups:</strong> Numeo does not maintain backups of your data on any servers.</p>
      </LegalSection>

      <LegalSection title="8. Cookies and Tracking Technologies">
        <p>Numeo does NOT use:</p>
        <ul>
          <li>Cookies</li>
      ...
      <LegalSection title="9. Your Rights">
        <p><strong>Access:</strong> You have full access to all your data stored in Numeo at any time through the app.</p>
      ...
      <LegalSection title="10. International Data Transfers">
        <p>Since Numeo operates entirely on your device, no data transfers occur internationally. Your data never leaves your device or local backups.</p>
      </LegalSection>

      <LegalSection title="11. Children's Privacy">
        <p>Numeo is not directed at children under the age of 13. We do not knowingly collect personal information from children. Since Numeo collects no personal information from anyone, this applies equally to all users regardless of age.</p>
        <p>If you believe a child has provided information to Numeo, please contact us immediately at hello@nafish.me.</p>
      </LegalSection>
      ...
      <LegalSection title="12. Changes to This Policy">
        ...
        <p>Given the nature of Numeo's local-first architecture, changes to this policy are expected to be minimal. Significant changes will be communicated in advance.</p>
      </LegalSection>

      <LegalSection title="13. Data Safety & Transparency">
        <p>As required by Google Play's Data Safety section, we confirm:</p>
        <ul>
          <li><strong>Data Collected:</strong> No personal, financial, or identifying data is collected by Numeo or transmitted to any external service (except Google Play for in-app purchases)</li>
      ...
      <LegalSection title="15. Play Store Data Safety Compliance">
        <p>As required by Google Play's Data Safety section, Numeo provides complete transparency:</p>
        <ul>
          <li><strong>Data Collected:</strong> None. Numeo does not collect, access, or transmit any personal or financial data about you.</li>
          ...
          <li><strong>Secure Transmission:</strong> No data is transmitted from your device for Numeo purposes.</li>
        </ul>
      </LegalSection>

      <LegalSection title="16. California Consumer Privacy Act (CCPA)">
        <p>For California residents: Since Numeo collects no personal information, CCPA rights to access, delete, or opt-out do not apply in the traditional sense. However:</p>
        <ul>
