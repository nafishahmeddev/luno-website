  ...
  return (
    <>
      <LegalSection title="1. Information We Collect">
        <p>Fintraq does not collect any personal information. The app operates entirely offline and on-device. Specifically:</p>
        <ul>
        ...
        <p>The only data that exists in relation to Fintraq is data you create yourself, stored locally on your device.</p>
      </LegalSection>

      <LegalSection title="2. How Your Data Is Stored">
        <p>All data you enter into Fintraq — including transactions, account details, categories, and preferences — is stored in a SQLite database on your device. This data:</p>
        <ul>
          <li>Never leaves your device.</li>
          <li>Is not backed up to any Fintraq-operated cloud service.</li>
      ...
      <LegalSection title="3. Third-Party Services">
        <p>Fintraq does not integrate with any third-party analytics, advertising, or data services for tracking. However, we do use:</p>
        <ul>
          <li><strong>Google Play Billing:</strong> For processing in-app purchases (Premium features). Google Play Billing handles payment information but does NOT have access to your financial data stored in Fintraq.</li>
        ...
        <p>The following are NOT included in Fintraq:</p>
        <ul>
      ...
      <LegalSection title="4. In-App Purchases and Premium Features">
        <p>Fintraq offers both free and Fintraq Pro features. Fintraq Pro includes Dashboard insights (spending alerts, saving trends, weekly summaries), extended analytics (30-day, 90-day, 12-month ranges, period charts, category breakdowns, behavioral metrics), global search, and CSV export.</p>
        ...
        <ul>
          ...
          <li>Payment information (credit card, billing address) is handled by Google and is NOT stored in Fintraq</li>
        ...
        <ul>
          ...
          <li>Fintraq receives no information about your payment method or billing details</li>
          <li>Your purchase status is tied to your Google Play account, not to Fintraq's servers</li>
        </ul>
      </LegalSection>

      <LegalSection title="5. Data Deletion">
        <p>You have full control over your data at all times. To delete your data:</p>
        <ul>
          <li><strong>Factory reset:</strong> Navigate to Settings → Danger zone → Factory reset within the app to wipe all locally stored data immediately.</li>
      ...
      <LegalSection title="6. Data Security">
        <p>Fintraq implements security measures to protect your data:</p>
        <ul>
          ...
          <li>Your device's built-in security features (lock screen, biometric authentication) protect access to Fintraq</li>
        </ul>
      ...
      <LegalSection title="7. Data Retention and Backups">
        <p><strong>Data Retention:</strong> Fintraq retains your data for as long as you keep the app installed on your device. You can delete all data at any time using the factory reset feature.</p>
        <p><strong>Device Backups:</strong> If you use Android's automatic backup feature (Google Drive, other cloud services), your Fintraq data may be included based on your device settings. This is subject to those services' privacy policies, not ours.</p>
        <p><strong>Fintraq-Operated Backups:</strong> Fintraq does not maintain backups of your data on any servers.</p>
      </LegalSection>

      <LegalSection title="8. Cookies and Tracking Technologies">
        <p>Fintraq does NOT use:</p>
        <ul>
          <li>Cookies</li>
      ...
      <LegalSection title="9. Your Rights">
        <p><strong>Access:</strong> You have full access to all your data stored in Fintraq at any time through the app.</p>
      ...
      <LegalSection title="10. International Data Transfers">
        <p>Since Fintraq operates entirely on your device, no data transfers occur internationally. Your data never leaves your device or local backups.</p>
      </LegalSection>

      <LegalSection title="11. Children's Privacy">
        <p>Fintraq is not directed at children under the age of 13. We do not knowingly collect personal information from children. Since Fintraq collects no personal information from anyone, this applies equally to all users regardless of age.</p>
        <p>If you believe a child has provided information to Fintraq, please contact us immediately at hello@nafish.me.</p>
      </LegalSection>
      ...
      <LegalSection title="12. Changes to This Policy">
        ...
        <p>Given the nature of Fintraq's local-first architecture, changes to this policy are expected to be minimal. Significant changes will be communicated in advance.</p>
      </LegalSection>

      <LegalSection title="13. Data Safety & Transparency">
        <p>As required by Google Play's Data Safety section, we confirm:</p>
        <ul>
          <li><strong>Data Collected:</strong> No personal, financial, or identifying data is collected by Fintraq or transmitted to any external service (except Google Play for in-app purchases)</li>
      ...
      <LegalSection title="15. Play Store Data Safety Compliance">
        <p>As required by Google Play's Data Safety section, Fintraq provides complete transparency:</p>
        <ul>
          <li><strong>Data Collected:</strong> None. Fintraq does not collect, access, or transmit any personal or financial data about you.</li>
          ...
          <li><strong>Secure Transmission:</strong> No data is transmitted from your device for Fintraq purposes.</li>
        </ul>
      </LegalSection>

      <LegalSection title="16. California Consumer Privacy Act (CCPA)">
        <p>For California residents: Since Fintraq collects no personal information, CCPA rights to access, delete, or opt-out do not apply in the traditional sense. However:</p>
        <ul>
