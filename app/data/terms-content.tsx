  ...
  return (
    <>
      <LegalSection title="1. Acceptance of Terms">
        <p>By downloading, installing, or using Numeo ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.</p>
        <p>These Terms constitute the entire agreement between you and the Numeo team regarding your use of the App.</p>
      </LegalSection>

      <LegalSection title="2. Eligibility">
        <p>By using Numeo, you represent and warrant that:</p>
        <ul>
          <li>You are at least 18 years of age</li>
          <li>You have the legal authority to enter into these Terms</li>
          <li>You will comply with all applicable laws and regulations</li>
        </ul>
        <p>Numeo is not intended for users under 13 years of age. Parental consent is required for users aged 13–18.</p>
      </LegalSection>

      <LegalSection title="3. Description of Service">
        <p>Numeo is a personal finance tracking application for Android devices. It provides tools to:</p>
        <ul>
        ...
        <p>All functionality operates entirely on your device. Numeo does not connect to any external servers, banking institutions, or financial services on your behalf (except for Google Play Billing for premium purchases).</p>
      </LegalSection>

      <LegalSection title="4. License and Intellectual Property">
        <p>Subject to your compliance with these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to download and use Numeo for your personal, non-commercial purposes on devices you own or control.</p>
        <p>You may not:</p>
        <ul>
        ...
        <p><strong>Our Intellectual Property:</strong> All content, features, and functionality of the Numeo app (including but not limited to software, text, graphics, logos, images, and sound) are owned by Numeo, its content providers, or other providers of such material and are protected by international copyright, trademark, and other intellectual property laws.</p>
      </LegalSection>

      <LegalSection title="5. Free and Premium Features">
        <p>Numeo is offered in two tiers:</p>
        <h3>Free Tier</h3>
        <ul>
      ...
      <LegalSection title="6. In-App Purchases and Payments">
        <p>Numeo offers premium features through a one-time lifetime purchase model:</p>
        <ul>
        ...
        <ul>
          ...
          <li>Numeo does NOT store, access, or process your payment information</li>
        ...
        <p>Numeo maintains no payment records and cannot process refunds directly. All refund requests must be made through Google Play.</p>
      </LegalSection>
      ...
      <LegalSection title="7. Purchase Restoration & Management">
        ...
        <ul>
          ...
          <li>Reinstall Numeo or use in-app purchase restore flow (if available)</li>
          <li>Google Play will validate and restore premium entitlement</li>
        </ul>
        <p>For billing or entitlement issues, contact Google Play Support first, then contact Numeo support if needed.</p>
      </LegalSection>

      <LegalSection title="8. Your Data and Responsibilities">
        <p>Since Numeo operates entirely on-device, you are solely responsible for:</p>
        <ul>
        ...
        <p>Numeo is a personal record-keeping tool, not a certified financial advisor. The insights and metrics displayed (such as savings rate, daily burn, and runway) are calculated from the data you provide and should not be treated as professional financial advice.</p>
      </LegalSection>
      ...
      <LegalSection title="10. Limitation of Liability">
        <p>To the fullest extent permitted by law, the Numeo team shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
        <ul>
      ...
      <LegalSection title="11. Prohibited Conduct & Acceptable Use">
        <p>You agree to use Numeo only for lawful purposes and in a manner that does not infringe the rights of others. You agree not to:</p>
        <ul>
      ...
      <LegalSection title="12. Indemnification">
        <p>You agree to indemnify, defend, and hold harmless Numeo and its operators from any claims, liabilities, damages, losses, costs, or expenses (including attorneys' fees) arising from:</p>
        <ul>
      ...
      <LegalSection title="14. Account Termination">
        <p>We reserve the right to terminate your access to Numeo if you violate these Terms or engage in prohibited conduct. Upon termination:</p>
        <ul>
      ...
      <LegalSection title="15. Severability & Entire Agreement">
        ...
        <p><strong>Entire Agreement:</strong> These Terms constitute the entire agreement between you and Numeo regarding the App and supersede all prior negotiations, representations, and agreements.</p>
      </LegalSection>
      ...
      <LegalSection title="17. Service Level & Availability">
        <p>Numeo is provided "as is" and we do not guarantee any specific uptime or availability guarantees since it operates entirely on your device. However, the app strives for reliability and bug-free operation.</p>
      ...
      <LegalSection title="18. Content & Intellectual Property">
        <p>Numeo contains proprietary content, including software, trademarks, logos, and design elements. You may not:</p>
        <ul>
          <li>Copy, modify, or distribute this content</li>
          <li>Remove or alter copyright notices or other proprietary markings</li>
          <li>Use Numeo's branding without explicit permission</li>
        </ul>
      ...
      <LegalSection title="19. Compliance with Google Play Policies">
        <p>Numeo complies with Google Play's Terms of Service and Developer Program Policies, including:</p>
        <ul>
          ...
          <li><strong>Deceptive Practices:</strong> Numeo does not engage in deceptive practices. We clearly communicate features and pricing.</li>
